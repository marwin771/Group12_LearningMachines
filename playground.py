...
def image_test(num = '', type = 'png'):
    ...
    masked_green[mask_green > 0] = [255, 255, 255]
    masked_green[mask_green <= 0] = [0, 0, 0]
    
    masked_red1 = image.copy()
    masked_red1[mask_red1 > 0] = [255, 255, 255]
    masked_red1[mask_red1 <= 0] = [0, 0, 0]

    masked_red2 = image.copy()
    masked_red2[mask_red2 > 0] = [255, 255, 255]
    ...
    cv2.imwrite(f"playground_results/result{num}_green.png", masked_green)
    cv2.imwrite(f"playground_results/result{num}_red.png", masked_red)
